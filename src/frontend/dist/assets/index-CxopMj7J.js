...
function MetricRow({ label, value, highlight }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        className: `font-mono text-2xl font-bold tracking-tight leading-none ${highlight ? "text-primary" : "text-foreground"}`,
        children: value
      }
    )
  ] });
}
function MetricsPanel({ steps, currentStepData, status }) {
  const recentSteps = steps.slice(Math.max(0, steps.length - 20)).reverse();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-5 animate-slide-down", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "metric-label tracking-widest uppercase", children: "Live Simulation Metrics" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MetricRow,
        {
          label: "Iteration Count",
          value: String((currentStepData == null ? void 0 : currentStepData.iteration) ?? 0),
          highlight: true
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MetricRow,
        {
          ...
          value: ((currentStepData == null ? void 0 : currentStepData.x) ?? 0).toFixed(4)
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MetricRow,
        {
          ...
          value: ((currentStepData == null ? void 0 : currentStepData.loss) ?? 0).toFixed(4)
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MetricRow,
        {
          ...
          value: Math.abs((currentStepData == null ? void 0 : currentStepData.gradient) ?? 0).toFixed(4)
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "metric-label", children: "Convergence Status" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "metric-label tracking-widest uppercase mb-3", children: "Parameter History" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          "data-ocid": "history.list",
          className: "space-y-0.5 max-h-64 overflow-y-auto scrollbar-thin",
          children: recentSteps.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs text-muted-foreground", children: "No steps yet" }) : recentSteps.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-ocid": `history.item.${i + 1}`,
              className: `flex justify-between items-center px-2 py-1 rounded text-[11px] font-mono ${i === 0 ? "bg-primary/10 text-primary" : "text-muted-foreground hover:text-foreground hover:bg-muted/30"} transition-colors duration-100`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  "Iteration ",
                  String(s.iteration).padStart(3, " ")
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: s.x.toFixed(4) })
              ]
            },
            `hist-${s.iteration}`
          ))
    ...
    steps.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "metric-label tracking-widest uppercase mb-2", children: "Loss Trajectory" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end gap-px h-12", children: steps.slice(-30).map((s, i) => {
        const window2 = steps.slice(-30);
        const maxLoss = Math.max(...window2.map((x) => x.loss), 0.01);
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              height: `${barH}px`,
              background: i === steps.slice(-30).length - 1 ? "oklch(0.68 0.25 310)" : "oklch(0.65 0.22 200 / 0.5)"
            },
...
function buildCurvePoints(xMin, xMax, steps = 200) {
  const points = [];
...
function computeNextX(x, grad, config, state, optimizer) {
...
function checkStatus(x, grad, iteration, config) {
...
function PlotCanvas({
  ...
  const curvePath = curvePoints.map(
    (p, i) => `${i === 0 ? "M" : "L"} ${toSvgX(p.x).toFixed(2)} ${toSvgY(p.y).toFixed(2)}`
  ).join(" ");
  const visibleSteps = steps.slice(0, currentStepIndex + 1);
  const descentPath = visibleSteps.map(
    (s, i) => `${i === 0 ? "M" : "L"} ${toSvgX(s.x).toFixed(2)} ${toSvgY(s.loss).toFixed(2)}`
  ).join(" ");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center p-4 plot-grid", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-3xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-center font-display text-sm font-semibold text-foreground mb-2 tracking-wide", children: [
        "Visualizing Gradient Descent: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-primary italic", children: "f(x) = x²" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Gradient descent plot: f(x) = x squared" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: "markerGrad", cx: "50%", cy: "50%", r: "50%", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "stop",
                  {
                    offset: "0%",
            ...
            xTicks.map((tick) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "line",
              {
                x1: toSvgX(tick),
                y1: PLOT.marginTop,
            ...
            yTicks.map((tick) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "line",
              {
                x1: PLOT.marginLeft,
                y1: toSvgY(tick),
            ...
            visibleSteps.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "path",
                {
                  d: descentPath,
            ...
            visibleSteps.slice(0, -1).map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "circle",
              {
                cx: toSvgX(s.x),
                cy: toSvgY(s.loss),
            ...
            markerX !== null && markerY !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "circle",
                {
                  cx: markerX,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shrink-0 border-t border-border bg-card px-5 py-3 flex items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 14 })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-1 max-w-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "label",
          {
            htmlFor: "speed-slider",
            className: "metric-label whitespace-nowrap",
            children: "Animated Step Speed"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            style: {
              background: `linear-gradient(to right, oklch(0.65 0.22 200) 0%, oklch(0.65 0.22 200) ${(config.animationSpeed - 50) / (1e3 - 50) * 100}%, oklch(0.22 0 0) ${(config.animationSpeed - 50) / (1e3 - 50) * 100}%, oklch(0.22 0 0) 100%)`
            }
          }
        )
      ] }),
...
function SidebarControls({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-5 animate-slide-down", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "metric-label tracking-widest uppercase", children: "Configuration" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", "data-ocid": "lr.section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "lr-slider", className: "metric-label", children: "Learning Rate (α)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[11px] text-primary", children: config.learningRate.toFixed(3) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          ...
          onChange: (e) => onConfigChange("learningRate", Number.parseFloat(e.target.value)),
          ...
          style: {
            background: `linear-gradient(to right, oklch(0.65 0.22 200) 0%, oklch(0.65 0.22 200) ${(config.learningRate - 1e-3) / (0.5 - 1e-3) * 100}%, oklch(0.22 0 0) ${(config.learningRate - 1e-3) / (0.5 - 1e-3) * 100}%, oklch(0.22 0 0) 100%)`
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[9px] text-muted-foreground", children: "0.001" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[9px] text-muted-foreground", children: "0.5" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "lr-input", className: "metric-label block mb-1", children: "α value" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "lr-input",
              ...
              onChange: (e) => {
                const v = Math.max(
                  1e-3,
                  Math.min(0.5, Number.parseFloat(e.target.value) || 1e-3)
                );
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "start-x-input", className: "metric-label block mb-1", children: "Start x₀" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "start-x-input",
              ...
              step: 0.5,
              value: config.startX,
              onChange: (e) => onConfigChange("startX", Number.parseFloat(e.target.value) || 0),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", "data-ocid": "controls.section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 14 }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-4 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            ...
            onChange: (e) => onConfigChange("optimizer", e.target.value),
            ...
            children: OPTIMIZER_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "option",
              {
                value: opt.value,
      ...
      (config.optimizer === "momentum" || config.optimizer === "adam") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "momentum-slider", className: "metric-label", children: "Momentum (β)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[11px] text-muted-foreground", children: config.momentum.toFixed(2) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => onConfigChange("momentum", Number.parseFloat(e.target.value)),
            ...
            style: {
              background: `linear-gradient(to right, oklch(0.68 0.25 310) 0%, oklch(0.68 0.25 310) ${(config.momentum - 0.1) / (0.99 - 0.1) * 100}%, oklch(0.22 0 0) ${(config.momentum - 0.1) / (0.99 - 0.1) * 100}%, oklch(0.22 0 0) 100%)`
            }
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "max-iter-input", className: "metric-label block mb-1.5", children: "Max Iterations" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            id: "max-iter-input",
...
function useGradientDescent() {
  ...
  const advanceStep = reactExports.useCallback(
    (prev) => {
  ...
  const currentStepData = state.steps[state.currentStep] ?? state.steps[state.steps.length - 1];
  return {
    state,
    currentStepData,
    play,
...
function VisualizerPage() {
  ...
  const statusClass = gd.state.status === "running" ? "border-primary/50 text-primary bg-primary/10" : gd.state.status === "converged" ? "border-chart-3/50 text-chart-3 bg-chart-3/10" : gd.state.status === "diverged" ? "border-destructive/50 text-destructive bg-destructive/10" : "border-border text-muted-foreground bg-muted/30";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-screen bg-background overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between px-5 py-3 bg-card border-b border-border shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display text-sm font-bold tracking-widest text-foreground uppercase", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Gradient" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "Flow" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] text-muted-foreground tracking-wider uppercase", children: "Descent Visualizer" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          ...
          children: gd.state.status.toUpperCase()
        }
      )
    ] }),
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(VisualizerPage, {});
}
